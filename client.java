...
*	4) Mostly Done once (5) is solved, this should be done too -- Get serialization and deserialization working.
*	5) Mostly Done, gotta solve an error -- Send file by packets class.
